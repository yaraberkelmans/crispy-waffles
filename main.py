...
if __name__ == "__main__":
    ...
    malus_point_list = get_scores('results/pickle_files/for_real/2/SimulatedAnnealing_True_heuristic_5_number_of_swaps_20000_iterations__Temp=1.0_Results.csv')
    plot_malus_histogram(malus_point_list, output_file_name='results/plots/SA_5S_heur_True', bins='auto', info='Algorithm: Simulated Annealing, Starting swaps: 5, Iterations: 20000, N=20', export=True, suptitle='Histogram of Malus Points - Heuristics on', binwidth=None)